function SimPhantom = generate_FFT_AMARES_Fitting(main_path, SimParam,img_t)
...
SimPhantom.AMARESresults = ...
    AMARES4recon(main_path, SimPhantom.img_t, SimPhantom.Param, SimPhantom.ppmaxis, SimPhantom.HDOfreq);
