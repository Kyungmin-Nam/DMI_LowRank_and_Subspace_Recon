function ShowAmaresfit_vTEST(inputspec,DMIResults,row,col,slice,xaxis,Parameters,Referenceloc)
...
fit=fftshift(fft(sum(Resultfid,2))).*Parameters.FirstOrdPhaseFunct;
