function DMIResults=AMARES4recon(main_path, inputfids,Parameters,xaxis,waterloc)

defaultfolder=cd;
addpath(strcat(main_path,'\OXSA-master\main'));


AMARESfolder            = strcat(main_path,'\thirdparty\PriorknowledgeandShowfit');
